...
public abstract class AbsBaseAdapter<T> extends BaseAdapter {
	...
	protected class ViewHolder{
		...
		public ViewHolder setViewVisible(int id, int visible) {
			getView(id).setVisibility(visible);
			return this;
		}

		public ViewHolder setOnClickListenerAndTag(int id, View.OnClickListener listener, Object tag) {
			View v = getView(id);
			v.setTag(tag);
		 ...
		 * 绑定SimpleDraweeView
		 */
		public ViewHolder bindSimpleDraweeViewBase(int id, String url){
